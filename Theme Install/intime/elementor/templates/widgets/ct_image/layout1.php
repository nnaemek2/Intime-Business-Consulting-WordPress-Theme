...
<div class="ct-image-single <?php if($img_tilt == 'yes') { echo 'img-hover-scale'; } ?> <?php echo esc_attr($ct_animate); ?>">
    <?php if ($image_type == 'img') { ?>
        <?php if(!empty($img_caption)) : ?><figure class="wp-caption"><?php endif; ?>
            ...
            <figcaption class="widget-image-caption wp-caption-text"><?php echo esc_attr($img_caption); ?></figcaption>
        </figure><?php endif; ?>
    <?php } else { ?>
